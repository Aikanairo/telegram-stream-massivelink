...
async def stream_handler(request: web.Request):
    ...
    try:
        ...
        if match:
            ...
            channel_id = request.rel_url.query.get("chid")
            print(channel_id)
        return await media_streamer(request, message_id, secure_hash, channel_id)
...
async def media_streamer(request: web.Request, message_id: int, secure_hash: str, chid = None ):
    ...
    file_id = await tg_connect.get_file_properties(message_id, chid)
